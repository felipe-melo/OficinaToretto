...
CREATE TABLE "orcamento" (
	...
	"carr_id" bigint NOT NULL,
	"quan_id" bigint NOT NULL,
	"orca_quilometragem" double NOT NULL,
...
CREATE TABLE "cartao_credito" (
	"paga_id" bigint NOT NULL,
	"cred_quantidade_parcelas" int NOT NULL,
...
ALTER TABLE "orcamento" ADD CONSTRAINT "orcamento_fk1" FOREIGN KEY (quan_id) REFERENCES quantidade_gasolina(quan_id);
